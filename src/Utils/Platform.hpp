...
#else
#	ifdef __SWITCH__
#		define MODULE_EXTENSION ".nro"
#		define __rescall
#		define __cdecl
// #		define __fastcall // Already defined through devkitpro
#		define DLL_EXPORT extern "C"
// 	TODO: Figure out what these should be for Switch
// #		define SEEK_DIR_CUR
// #		define STDCALL_NAME(base, param_bytes)
#	else
