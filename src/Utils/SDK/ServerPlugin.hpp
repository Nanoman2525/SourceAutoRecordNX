...
struct CPlugin {
	char m_szName[128];                 // 0   (Switch: 0)
	bool m_bDisable;                    // 128 (Switch: 128)
	IServerPluginCallbacks *m_pPlugin;  // 132 (Switch: 136)
	int m_iPluginInterfaceVersion;      // 136 (Switch: 144)
	void *m_pPluginModule;              // 140 (Switch: 152)
};
